...
# project. Then Camden Voigt adapted it for this project.
...
RUN --mount=type=bind,source=src,target=src \
    ...
    --mount=type=bind,source=seed-quotes,target=seed-quotes \
...
COPY --chown=appuser:appuser seed-quotes ./seed-quotes
...
CMD ["/bin/quote-server", "-i", "seed-quotes/quotes.csv", "-a", "0.0.0.0"]
